...
<div class="box">
 ...
 <tr>
    ...
    <a href="beranda.php?p=formeditpelanggan&kdpelanggan=<?php echo $data['kdpelanggan'] ?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
    <a href="beranda.php?p=proseshapuspelanggan&kdpelanggan=<?php echo $data['kdpelanggan'] ?>" onclick="pesan = confirm('Yakin data di hapus?');
